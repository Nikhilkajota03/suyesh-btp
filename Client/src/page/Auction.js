  ...
  return (
    <>
      <div className="bg-purple-900 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 flex flex-col gap-10 items-center bottom-0 leading-5 h-[100vh] w-full overflow-hidden">
        ...
        <div className="text-white text-4xl mt-[10rem] font-bold">Auction</div>
              ...
              <tbody className="text-gray-700">
                ...
                {order.map((value, index) => (
                  <tr key={index}>
                    ...
                    <td className="text-left py-3 px-4">{value.maxunit}</td>
                    <td className="text-left py-3 px-4">{value.minprice}</td>
                    <td>
                    <button
                        type="button"
                        className={` {  ${doneIndex.includes(index) ? "focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" : "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 "  }  `}
                      ...
                      >
                        ...
                        <Link
                          to={`/auctionbids/${value._id}/${value.walletaddre}/${index}/${value.user}`}
                        >
                          Bids
                        </Link>
