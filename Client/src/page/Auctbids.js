...
const Auctbids = () => {
  ...
  return (
    <div className="bg-purple-900 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 flex flex-col gap-10 items-center bottom-0 leading-5 h-[100vh] w-full overflow-hidden">
      ...
      <div className="text-white text-4xl mt-[10rem] font-bold">Bids</div>
              ...
              {  bids.length===0 ? <div className="p-5 text-red">No Bid placed Till Now</div> :    bids.map((value, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <button
                      onClick={() =>
                        AcceptBid(value.bidderwallet, value.bidAmount, index)
                      }
                      type="button"
                      class= { `${walletAdd === receiverwallet ? "text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" : "focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"} `}
